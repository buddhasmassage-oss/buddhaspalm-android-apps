...
public class OverlayService extends Service {
    ...
    private void createOverlay() {
        ...
        ball.setImageResource(net.buddhaspinas.screenrecorder.R.drawable.app_logo);
        ...
        ball.setPadding(dp(4), dp(4), dp(4), dp(4));
        LinearLayout.LayoutParams bp = new LinearLayout.LayoutParams(dp(58), dp(58));
        overlay.addView(ball, bp);
        ...
        files.setOnClickListener(v -> {
            Intent i = new Intent(this, RecordingsActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(i);
            controls.setVisibility(View.GONE);
        });
