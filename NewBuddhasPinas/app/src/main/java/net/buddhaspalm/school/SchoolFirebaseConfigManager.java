...
public final class SchoolFirebaseConfigManager {
    private static final String TAG = "SchoolFirebaseConfig";
    private static final String PREF = "buddhaspinas_firebase";
    private static final String URL_CONFIG = "https://school.buddhaspinas.com/api.php?action=fcm_public_config";

    private SchoolFirebaseConfigManager() {}
            ...
            try {
                ...
                if (code >= 200 && code < 300) {
                    ...
                    if (!j.optBoolean("enabled", false)) {
                        message = "FCM is disabled in school admin";
                    } else {
                        ...
                        if (!appId.isEmpty() && !apiKey.isEmpty() && !projectId.isEmpty() && !senderId.isEmpty()) {
                            ...
                            message = "Import google-services.json in school admin first";
                        }
                    }
                } else {
