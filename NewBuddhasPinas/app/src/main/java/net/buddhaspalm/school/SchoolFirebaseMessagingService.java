...
public class SchoolFirebaseMessagingService extends FirebaseMessagingService {
    public static final String CHANNEL_ID = "new_buddhaspinas_alerts";
    ...
    @Override public void onNewToken(String token) {
        ...
        getSharedPreferences("buddhaspinas_native", MODE_PRIVATE)
                .edit()
    ...
    @Override public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (data != null) {
            ...
            if (isSafeSchoolUrl(candidate)) clickUrl = candidate;
        }
    ...
    private static boolean isSafeSchoolUrl(String url) {
    ...
    public static void ensureNotificationChannel(Context context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel ch = new NotificationChannel(
                    CHANNEL_ID,
                    "New BuddhasPinas Alerts",
                    NotificationManager.IMPORTANCE_HIGH
            );
            ch.setDescription("Chat, order, plan, quiz and account notifications from New BuddhasPinas");
