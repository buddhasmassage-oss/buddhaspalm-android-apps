...
public class BookingAlarmService extends Service {
    public static final String ACTION_START="com.buddhaspalm.provider.BOOKING_ALARM_START";
    public static final String ACTION_STOP="com.buddhaspalm.provider.BOOKING_ALARM_STOP";
