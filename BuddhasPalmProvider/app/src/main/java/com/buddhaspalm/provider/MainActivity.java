...
public class MainActivity extends Activity {
    ...
    private void configureWebView() {
        ...
        s.setUserAgentString(s.getUserAgentString() + " BuddhasPalm-Provider-Android/1.1");
    ...
    private void maybeOfferNativePushPermission() {
        ...
        runOnUiThread(() -> new AlertDialog.Builder(this)
                ...
                .setMessage("Allow OneSignal notifications so new bookings and booking updates can reach Provider app even when the app is closed.")
