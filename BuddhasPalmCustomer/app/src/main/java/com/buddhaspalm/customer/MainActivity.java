package com.buddhaspalm.customer;
...
public class MainActivity extends Activity {
    ...
    private static final String HOST = "metro.buddhaspinas.com";
    private static final String START_URL = "https://metro.buddhaspinas.com/";
    ...
    private void configureWebView() {
        ...
        s.setUserAgentString(s.getUserAgentString() + " BuddhasPalm-Customer-Android/1.0.0");
    ...
    private void loadInitialUrl(Intent intent) {
        ...
        if (data != null && "https".equalsIgnoreCase(data.getScheme()) && HOST.equalsIgnoreCase(data.getHost())) {
